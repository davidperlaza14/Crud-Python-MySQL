...
class Ventana(Frame):
    ...
    def fGuardar(self):
        if self.id == -1:
            ...
            messagebox.showinfo("Insertear", 'Elemento insertado correctamente.')
    ...
    def create_widgets(self):
        ...
        frame2.place(x=95,y=0, width=450, height=259)
        ...
        frame3.place(x=247,y=0,width=400, height=259)
        ...
        self.grid.heading("col2", text="Contry Name", anchor=CENTER)
